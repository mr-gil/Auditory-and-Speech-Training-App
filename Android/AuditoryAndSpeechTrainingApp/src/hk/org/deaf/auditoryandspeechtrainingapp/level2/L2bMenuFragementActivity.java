...
public class L2bMenuFragementActivity extends FullScreenFragmentActivity {
	private View currentSelectedBtn;
	@Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setToFullScreen();
        setContentView(R.layout.level2b_menu_revised);
        setContentLayout();
        setSelectionBtnLayout();
    }

    private void setContentLayout(){
    	//xmlLayoutConnection(R.drawable.box_menu, R.layout.level2b_menu, R.drawable.by_menu);
    ...
    class SelectionBtnListener implements OnClickListener {
		...
		public void onClick(View v) {
			...
			if (v.getId() == R.id.main_page_back_btn){
				...
				Intent intent = new Intent(L2bMenuFragementActivity.this, L2bTestFragementActivity.class);
